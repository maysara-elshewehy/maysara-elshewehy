...
- ## The Problem
  ...
  > Not because they failed,because chaos is unbearable to a perfectionist's mind.
  >
...
- ## Plan {A}
  ...
  > over the past 25 years, I've proven to myself (quite convincingly) that I'm terrible at planning, so I'll just skip that part ..!
    ...
    - ### [0]
       ...
       > [`@minejs`](https://github.com/minejs-org) + [`@minejsx`](https://github.com/minejsx-org) + [`@cruxjs`](https://github.com/cruxjs-org) + [`@mineui`](https://github.com/mineui-org) + [`@cruxui`](https://github.com/cruxui-org) + [`@cruxup`](https://github.com/cruxup-org)
